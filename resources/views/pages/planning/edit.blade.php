        ...
        <div class="col-md-12">
            <div class="card bg-card">
                <div class="card-body">
                   ...
                   <div class="row">
                    <div class="col-md-12">
                        <form enctype="multipart/form-data" class="form-group" method="POST" action="{{ route('planning.update', $planning)}}" >
                          @csrf
                            @method('PATCH')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" name="plan_start_date" value="{{old('plan_start_date') ?? $planning->plan_start_date }}"/>
                                ...
                                <div class="col-md-6">
                                    <label for="Name" class="form-label">Plan End Date<a
                                                    style="text-decoration: none;color:red">*</a></label>
                                    <input type="date" class="form-control" name="plan_end_date" value="{{old('plan_end_date') ?? $planning->plan_end_date}}"/>
                            ...
                            <div class="row">
                                    ...
                                    <input type="date" class="form-control" name="mail_send_date" value="{{old('mail_send_date') ?? $planning->mail_send_date}}"/>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="date" class="form-control" name="explanation_date" value="{{old('explanation_date') ?? $planning->explanation_date}}"/>
                                  ...
                                  @endif
                                    ...
                                    <input type="text" class="form-control" name="objective" value="{{old('objective') ?? $planning->objective }}"/>
                            ...
                            <div class="row">
                                    ...
                                    <textarea class="form-control" name="exercise_routine">{{ old('exercise_routine') ?? $planning->exercise_routine }}</textarea>
                            ...
                            <div class="row">
                                    ...
                                    <textarea class="form-control" name="comments">{{ old('comments') ?? $planning->comments }}</textarea>
                                   ...
                                   <div style="position:absolute;right:-5px;top:-13px;cursor:pointer;" onclick=deleteCard({{$key}},{{$id}})>
                                    ...
                                    <div class="row">
                                       <div class="col-md-4">
                                         ...
                                         <select required name="meal_category[]" id="select_meal_category_{{$key}}" class="form-control" >
                                           <option value="">--- Select any one ---</option>
                                              @if(MEALCATEGORY) 
                                                <?php $val = true ?>
                                              @foreach (MEALCATEGORY as $key => $value )
                                                @if($plan_type->meal_category == $value)
                                                <?php $val = false ?>
                                                @endif
                                                  <option @if($plan_type->meal_category == $value)  selected @endif value="{{ $key }}">{{ $value }}</option>
                                               @endforeach
                                               @endif 
                                               @if($val)
                                               <option value="{{$plan_type->meal_category}}" selected>{{$plan_type->meal_category}}</option>
                                               @endif  
                                           </select>
                                         </div>
                                          <div class="col-md-4">
                                           <label class="form-label">Food Details<a style="text-decoration: none;color:red">*</a></label>
                                          <input class="form-control" required type="text" id="food_details_{{$key}}" name="food_details[]" value="{{ $plan_type->food_details }}"> 
                                        </div>
                                         <div class="col-md-4">
                                           <label class="form-label">Meal Time<a style="text-decoration: none;color:red">*</a></label>
                                          <input class="form-control" required type="time" id="meal_time_{{$key}}" name="meal_time[]" value="{{ $plan_type->meal_time }}"> 
                                        </div>
                                       </div>
                                </div>
                            </div>
                            @endforeach
                                          @elseif($meal_categories )
