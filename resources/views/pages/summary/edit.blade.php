            ...
            <div class="card bg-card">
                <div class="card-body">
                   ...
                   <div class="row">
                    <div class="col-md-12">
                        @if($summary)
                        <form enctype="multipart/form-data" class="form-group" method="POST" action="{{ route('summary.update', $summary)}}" >
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" name="summary_date" value="{{old('summary_date') ??  \Carbon\Carbon::parse($summary->summary_date)->format('Y-m-d') }}"/>
                            ...
                            <div class="row">
                                    ...
                                    <label for="Name" class="form-label">Assessment Details<a
                                                    style="text-decoration: none;color:red">*</a></label>
                                    <textarea class="form-control" name="summary_details">{{old('summary_details') ?? $summary->summary_details}}</textarea>
